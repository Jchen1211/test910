...
#' @param permut The number of permutations for p value. Default: 1000.
#'
#' @return A list for regression result.
#' @export
#'
#' @examples
#' perscore <- matrix_permutation(X, Y, lamb = 0.01, permut = 1000)
matrix_permutation <- function(X, Y, lamb = 0.01, permut = 1000){
